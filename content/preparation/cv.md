...
Automatically compare your resume to the job description. Ranks each applicant based on how well their resume scores based on the job description.
Usually recruiters filter resumes by searching for key skills and titles.
 - Carefully tailor your resume to the job description every single time
   you apply.
  - Optimize for ATS search and ranking algorithms by
...
- **Length**: Just 1 page non-compulsory. Long enough to tell your story.
- Usually One page if you have less than 10 years of experience.
- Don’t put anything less recent than 3-4 years unless they are valid job experiences.
- **File Name:** firstname_lastname_Resume.pdf
- **Content order**: Info, brief description, skills, Employment history, Education, projects, Hobby
- **Links**: use Bitly so you can look at who clicked on it
...
- **If you have never worked**, you can list among your experiences projects that you have done during your college courses or that you have done in your spare time. It is important that the projects you list on your CV are also on [GitHub](https://github.com/) so that people reading your CV can view them.
  - The name of the project should imply what it does: e.g. "eCommerce for wine" anzi che "Wine in Milan".
  - Demo videos and project presentations should be very short (1 min).
  - Add links in the following format ```[code | article | paper | demo | video demo | presentation]```
- **If you have publications**, list them naming all other authors but highlight your name;
- **Use action verbs**. example: achieved, completed, expanded, exceeded, improved, pioneered, reduced (losses), resolved (issues), restored, spearheaded, succeeded, surpassed, transformed, won, analyzed, developed, directed, diagnosed, evaluated, examined, built, calculated, Conceptualized, Coded, coached, communicated, conducted, ...
